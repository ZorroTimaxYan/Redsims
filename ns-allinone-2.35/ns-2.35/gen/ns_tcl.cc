...
\"\n\
checkout_executable TCLSH \"/home/yzr/common/ns-allinone-2.35/bin/tclsh8.5\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/yzr/common/ns-allinone-2.35/bin/tclsh8.5\n\
but it doesn't seem to be there anymore, so\\\n\
...
\n\
Queue/Pared set pertime_ 1\n\
\n\
Queue/Ared set pertime_ 1\n\
\n\
Queue/Myred set pertime_ 1\n\
\n\
...
\n\
Queue/DWRR set buckets_ 10\n\
Queue/DWRR set blimit_ 25000\n\
\n\
Queue/PDWRR set buckets_ 10\n\
Queue/PDWRR set blimit_ 25000\n\
Queue/PDWRR set droprate_ 0\n\
Queue/PDWRR set droprate1_ 0\n\
Queue/PDWRR set droprate2_ 0\n\
Queue/PDWRR set droprate3_ 0\n\
Queue/PDWRR set totaldpcount 0\n\
\n\
Queue/DropTailT set drop_front_ false\n\
Queue/DropTailT set summarystats_ false\n\
Queue/DropTailT set queue_in_bytes_ false\n\
Queue/DropTailT set mean_pktsize_ 500\n\
\n\
...
\n\
Application/Traffic/MyPareto set burst_time_ 500ms\n\
Application/Traffic/MyPareto set idle_time_ 500ms\n\
Application/Traffic/MyPareto set rate_ 64Kb\n\
Application/Traffic/MyPareto set packetSize_ 210\n\
Application/Traffic/MyPareto set shape_ 1.5\n\
\n\
...
$self instvar link_ queueMap_ nullAgent_ useasim_ gqtype_\n\
set sid [$n1 id]\n\
set did [$n2 id]\n\
\n\
if { $useasim_ == 1 } {\n\
...
$self register-nam-linkconfig $link_($sid:$did)\n\
\n\
set gqtype_($sid:$did) $q\n\
return gqtype_\n\
}\n\
\n\
Simulator instproc mygettype { n1 n2 } {\n\
$self instvar gqtype_ Node_ \n\
...
\n\
if [info exists gqtype_($n1:$n2)] {\n\
return $gqtype_($n1:$n2)\n\
} else {\n\
puts 不存在队列\n\
}\n\
return \"\"\n\
...
if {$type == \"DropTailT\"} {\n\
eval $self simplex-link $n1 $n2 $bw $delay $type $args 1\n\
eval $self simplex-link $n2 $n1 $bw $delay $type $args 2\n\
} else {\n\
